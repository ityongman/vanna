"""
Deprecated: use vanna.integrations.llm.google instead.
...
from vanna.integrations.llm.google import *  # noqa: F401,F403
from vanna.integrations.llm.google import __all__  # noqa: F401

warnings.warn(
    "vanna.integrations.google is deprecated; "
    "import from vanna.integrations.llm.google instead.",
    DeprecationWarning,
    stacklevel=2,
)
