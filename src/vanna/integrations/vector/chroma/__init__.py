...
from .schema_vector_store import ChromaSchemaVectorStore
...
def create_sentence_transformer_embedding_function(
    ...
    Examples:
        ...
        >>> from vanna.integrations.vector.chroma import ChromaAgentMemory, create_sentence_transformer_embedding_function
