"""
Deprecated: use vanna.integrations.vector.faiss instead.
...
from vanna.integrations.vector.faiss import *  # noqa: F401,F403
from vanna.integrations.vector.faiss import __all__  # noqa: F401

warnings.warn(
    "vanna.integrations.faiss is deprecated; "
    "import from vanna.integrations.vector.faiss instead.",
    DeprecationWarning,
    stacklevel=2,
)
