"""
Deprecated: use vanna.integrations.vector.milvus instead.
...
from vanna.integrations.vector.milvus import *  # noqa: F401,F403
from vanna.integrations.vector.milvus import __all__  # noqa: F401

warnings.warn(
    "vanna.integrations.milvus is deprecated; "
    "import from vanna.integrations.vector.milvus instead.",
    DeprecationWarning,
    stacklevel=2,
)
